...
import { CreateGroupRequestSchema, UpdateGroupRequestSchema } from "../schemas/GroupsRequestSchema.js";
...
export class GroupsController {
    ...
    show: Handler = async (req, res, next) => {
        try {
            ...
            const group = await this.groupsRepository.deleteById(Number(req.params.id))
